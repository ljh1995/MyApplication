...
import com.example.administrator.myapplication.view.GestureLockView.Mode;
...
//    private int mFingerOnColor = 0xFF378FC9;
    private int mFingerOnColor = Color.parseColor("#A68BFF") ;
    /**
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_MOVE:
                mPaint.setColor(getResources().getColor(R.color.color_small_calendar_text));
//                mPaint.setAlpha(100);
