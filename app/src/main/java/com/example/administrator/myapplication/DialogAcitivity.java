...
public class DialogAcitivity extends Activity implements View.OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case Dialog.BUTTON_POSITIVE:
                        Toast.makeText(DialogAcitivity.this, "确认",
                    ...
                    case Dialog.BUTTON_NEUTRAL:
                        Toast.makeText(DialogAcitivity.this, "忽略",
                                Toast.LENGTH_SHORT).show();
                        break;
                }
            }
    ...
    private void dialogList() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(DialogAcitivity.this, items[which],
                        Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(DialogAcitivity.this, "确定", Toast.LENGTH_SHORT)
                        .show();
            }
        });
        builder.create().show();
...
//                }
    ...
    private void dialogEditText() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(DialogAcitivity.this, editText.getText().toString() + "", Toast.LENGTH_LONG).show();
            }
        });
